  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 animate-fade-in">
      <aside className="w-full md:w-1/4 lg:w-1/5">
        <div className="p-4 bg-white dark:bg-dark-surface rounded-xl shadow-lg h-full border border-gray-100 dark:border-gray-800">
          ...
          <nav className="flex flex-col space-y-1">
            ...
            <NavItem tab="banners" label="Home Banners" icon={<svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" /></svg>} />
      ...
      <main className="w-full md:w-3/4 lg:w-4/5">
        <div className="p-6 bg-white dark:bg-dark-surface rounded-xl shadow-lg h-full border border-gray-100 dark:border-gray-800">
          {renderTabContent()}
        </div>
      </main>
    </div>
